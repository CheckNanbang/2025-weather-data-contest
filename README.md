...
## 🔍 모델 해석 (SHAP 분석)
- **Cluster 0,3**: 겨울 여부, 체감온도 7일 이동평균이 주요 영향
- **Cluster 1,2 (여름모델)**: 시간대, 불쾌지수가 핵심 요인
- **Cluster 1,2 (비여름모델)**: 체감온도 이동평균, 계절성 변수가 중요
