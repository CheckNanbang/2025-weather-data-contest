...
class WeatherDataPreprocessor:
    ...
    def __init__(self):
        ...
        self.cluster_lag_config = {
            0: {
                'ta': list(range(1, 13)) + list(range(19, 27)),
                'wd': list(range(4, 18)) ,
                'ws': list(range(2, 30)),
                'rn_day': list(range(22, 25)),
                'rn_hr1' : [4],
                'hm': [1,2,3,4] + list(range(7, 20)) +list(range(24, 30)) ,
                'si': list(range(1, 6)) + list(range(9, 20)) + list(range(23, 30)),
                'ta_chi': list(range(1, 2)) + [30],
		        # 'year' : list(range(1, 30)) ,
                # 'month' : list(range(22,25)), 
                # 'day': [1,2,3,4, 7,8,9] + list(range(11, 23)),
                # 'day_of_week': list(range(1, 18)) + list(range(23, 28)),
		        # 'weekofyear' : list(range(1, 4)),
                'wd_rad': list(range(4, 18)),
                'wd_sin': [1,2] + list(range(8,24)),
                'wd_cos': list(range(3, 20)) + list(range(23, 29)),
            },
            1: {
                'ta': list(range(1, 17)) + list(range(20, 31)),
                'wd': [1,2] + list(range(6, 24)),
                'ws': list(range(1, 31)),
                'rn_day': [13,14,15],
                'hm': [2] + list(range(7, 18)) + list(range(22, 31)),
                'si': list(range(1, 8)) + list(range(10, 21)) + list(range(23, 31)),
                'ta_chi': list(range(1, 22)),
                'wd_rad': [1,2] + list(range(6, 24)),
                'wd_sin': [1,2,3] + list(range(5, 27)),
                'wd_cos': list(range(1, 21)) + [27,28,29,30],
            },
            3: {
                'ta': list(range(1, 15)) + [23, 24, 25],
                'wd': [9,10,11,13,14] + list(range(17, 20)),
                'ws': list(range(5, 25)),
                'rn_day': list(range(7, 11)),
                'hm': [1,2,3,4] + list(range(7,23)) ,
